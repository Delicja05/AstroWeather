...
public class SendRequest<T> extends JsonRequest<T> {

    final String appId = "V2IQbB7e";
    final String CONSUMER_KEY = "dj0yJmk9bFR0MmZhemEyZmxyJmQ9WVdrOVZqSkpVV0pDTjJVbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PTUw";
    final String CONSUMER_SECRET = "ef6238582134829415ee4a999795a5a44e688f75";
    final String baseUrl = "https://weather-ydn-yql.media.yahoo.com/forecastrss";
    private String city;
    private String dataFormat="";

    public SendRequest(int method, String url, String requestBody, Response.Listener<T> listener, Response.ErrorListener errorListener) {
